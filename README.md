...
| `IsHeadsetInsideASceneRoom` | `bool` | Headset is inward of every outer wall of a loaded room (doorway faces included). Floor-outline `IsPositionInRoom` is not enough — a hallway just outside still passed that. Always true in the editor |
