...
| `IsHeadsetInsideASceneRoom` | `bool` | Headset world pose is inside a loaded room volume. False in an uncaptured second room even when `HasSceneRooms` is true. Always true in the editor |
