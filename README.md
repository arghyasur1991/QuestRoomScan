...
| `SetBodyExclusionAnchors(head, left, right)` | `void` | Pin head + wrist transforms for torso/hand/forearm exclusion capsules (host-owned). Call before `StartScanAsync`. Null wrists skip that side |
