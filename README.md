...
| `ConfineScanToContainingRoom` | `bool` | When true, TSDF skips voxels outside the MRUK room that contained the headset at scan start. Default **false**. Set before `StartScanAsync`. `SCREEN` (TV) plane stamps still apply either way |
